...
// (#/wealth, #/places, #/reading, #/people) fall through to Today via
// pageFromHash's default below — books moved into Goals as a section.
...
export const TAB_PAGES: Page[] = [
  'today', 'journal', 'goals', 'finance', 'progress',
];
